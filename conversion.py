...
label_lat_deg = tk.Label(frame, text="      Grados,                      Minutos,                Segundos")
label_lat_deg.place(x=110, y=200)
...
entry_lat_deg.place(x=130, y=220, width=90)  # Se agrega la coma después de la coordenada x

'''Minutos'''
entry_lat_min = tk.Entry(frame)
entry_lat_min.place(x=230, y=220, width=90)  # Se agrega la coma después de la coordenada x

'''Segundos'''
entry_lat_sec = tk.Entry(frame)
entry_lat_sec.place(x=330, y=220, width=90)  # Se agrega la coma después de la coordenada x
...
entry_long_deg.place(x=130, y=250, width=90)

'''Minutos'''
entry_long_min = tk.Entry(frame)
entry_long_min.place(x=230, y=250, width=90)

'''Segundos'''
entry_long_sec = tk.Entry(frame)
entry_long_sec.place(x=330, y=250, width=90)
